...
const logger = common.getLogger("huobi");
...
const url = "https://api.huobipro.com/market/depth";
...
function call(base, quote) {
    ...
    let pair = new Pair(quote, base, "huobi");
    common.agentGet(url)
        .query({
        ...
        .end(function (err, res) {
            if (err) {
                ...
                let depth = common.safelyParseJSON(res.text).tick;
